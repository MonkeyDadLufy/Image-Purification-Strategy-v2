"""
Example: Simulate 25% low-dose from a PNG image and save result as PNG.
"""
...
def main():
    """
    Read a high-dose PNG image, simulate 25% low-dose, and save as PNG.
    ...
    # Simulate 25% dose. The PNG-based function assumes a reference exposure of 200 mAs,
    # so 25% corresponds to mas_des = 200 * 0.25 = 50.0
    mas_des = 2.5
